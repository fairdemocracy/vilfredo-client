...
function setVoteLinear(proposal) // bosh
{
...
function createLinearVoteMap(svg)
{
	//alert('createLinearVoteMap called');

	console.log('createLinearVoteMap called...');
